...
public class DuChaDetailActivity extends BaseActivity {
    ...
    private View.OnClickListener clkGotoPhotoView = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getTag() instanceof Integer) {
                Intent intent = new Intent(DuChaDetailActivity.this, PhotoViewActivity.class);
    ...
    private void initPhotoView(String urls) {
        ...
        if (list.size() > 0) {
            ...
            for (int i = 0; i < imgUrls.length; ++i) {
                ...
                ImgUtils.loadImage(DuChaDetailActivity.this, (ImageView) view.findViewById(R.id.iv_photo), url, R.drawable.im_loading, R.drawable.im_failed);
                view.setTag(i);
    ...
    private void loadData() {
        ...
        request = "duchaContent_data_get";
        params = ParamUtils.freeParam(null, "duchaId" , comp.getId());
    ...
    private View.OnClickListener btnClk = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getTag() instanceof CompSugs) {
                ...
                Intent intent = new Intent(DuChaDetailActivity.this, EvalCompActivity.class);
