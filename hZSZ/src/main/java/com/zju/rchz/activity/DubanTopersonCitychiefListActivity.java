...
public class DubanTopersonCitychiefListActivity extends BaseActivity implements ViewPager.OnPageChangeListener, RadioGroup.OnCheckedChangeListener{
        ...
        private View.OnClickListener btnClk = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v.getTag() instanceof DubanTopersonObject) {
                    ...
                    Intent intent = new Intent(DubanTopersonCitychiefListActivity.this,
                            DuabnTopersonCitychiefDetailActivity.class);
                    ...
                    intent.putExtra("functionCate",getUser().isLeader);//0表示正常身份的查看督办单，1表示领导查看的那个功能（R.id.rl_leaderDuban_list）
            ...
            public View initView(Context context, int position,
                ...
                if (convertView == null) {
                    convertView = LinearLayout.inflate(
                            DubanTopersonCitychiefListActivity.this,
...
//                warp.setText(R.id.tv_status, comp.getStatuss());  //处理状态
                ...
                warp.setText(R.id.tv_time, comp.getTime() != null ? comp
                        .getTime().getYMDHM(DubanTopersonCitychiefListActivity.this) : "");    //投诉时间
...
//                }
        ...
        public View getView() {
            if (view == null) {
                view = LinearLayout.inflate(DubanTopersonCitychiefListActivity.this,
                        R.layout.confs_chief_complist, null);
                adapter = new SimpleListAdapter(DubanTopersonCitychiefListActivity.this,
                        items, initor);
                listViewWarp = new ListViewWarp(DubanTopersonCitychiefListActivity.this,
                        adapter, this);
...
//        isLeaderDuban=getIntent(),getExtra()
        ...
        pagerItems.add(new DubanTopersonCitychiefListActivity.CompListPager(0));
        pagerItems.add(new DubanTopersonCitychiefListActivity.CompListPager(1));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ((DubanTopersonCitychiefListActivity.CompListPager) pagerItems
