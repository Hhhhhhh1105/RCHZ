...
public class InstrcutionListActivity extends BaseActivity implements ViewPager.OnPageChangeListener, RadioGroup.OnCheckedChangeListener{
        ...
        private View.OnClickListener btnClk = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v.getTag() instanceof DubanTopersonObject) {
                    ...
                    Intent intent = new Intent(InstrcutionListActivity.this,
                            InstructionAndReplyDetailActivity.class);

                    intent.putExtra(Tags.TAG_COMP, StrUtils.Obj2Str(comp));
                    intent.putExtra(Tags.TAG_HANDLED, type);    //0是未回复，1是已回复
        ...
        private SimpleViewInitor initor = new SimpleViewInitor() {
            ...
            public View initView(Context context, int position,
                ...
                warp.setText(R.id.tv_time, comp.getTime() != null ? comp
                        .getTime().getYMDHM(InstrcutionListActivity.this) : "");    //投诉时间
...
//                }
        ...
        public View getView() {
            if (view == null) {
                view = LinearLayout.inflate(InstrcutionListActivity.this,
                        R.layout.confs_chief_complist, null);
                adapter = new SimpleListAdapter(InstrcutionListActivity.this,
                        items, initor);
                listViewWarp = new ListViewWarp(InstrcutionListActivity.this,
                        adapter, this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pagerItems.add(new InstrcutionListActivity.CompListPager(0));
        pagerItems.add(new InstrcutionListActivity.CompListPager(1));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ((InstrcutionListActivity.CompListPager) pagerItems
