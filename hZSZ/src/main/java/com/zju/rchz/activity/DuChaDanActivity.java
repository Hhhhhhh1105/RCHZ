...
public class DuChaDanActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tv_suggest_river)).setText(R.string.form_ducha_river);
//            ((CheckBox) findViewById(R.id.ck_anonymity)).setText(R.string.form_complaint_anonymity);

//        ((EditText) findViewById(R.id.et_suggest_name)).setHint(R.string.hint_ducha_name);

        ((EditText) findViewById(R.id.et_suggest_subject)).setHint(R.string.hint_ducha_subject);
...
//            submitData();
            Toast.makeText(this,"您还没拍摄照片,请上传照片后完成督察单。",Toast.LENGTH_LONG).show();
        }
...
//        if (isCom) {
        getRequestContext().add("river_duchadan_action_add", new Callback<SugOrComRes>() {
            @Override
...
//        }
    ...
    private void doResult(SugOrComRes o) {
        ...
        ((TextView) findViewById(R.id.tv_submit_result)).setText(StrUtils.renderText(DuChaDanActivity.this, R.string.fmt_ducha_result, o.data.comOrAdvSerNum));
        ...
        if (getLocalService() != null) {
            getLocalService().getLocation(new LocalService.LocationCallback() {
                ...
                public void callback(Location location) {
                    DuChaDanActivity.this.location = location;
                }
            });
        }
    }
