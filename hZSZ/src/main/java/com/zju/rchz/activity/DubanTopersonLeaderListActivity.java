...
/**
 * Created by ZJTLM4600l on 2017/10/2.
 */

public class DubanTopersonLeaderListActivity extends BaseActivity implements ViewPager.OnPageChangeListener, RadioGroup.OnCheckedChangeListener {
        ...
        private View.OnClickListener btnClk = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v.getTag() instanceof DubanTopersonObject) {
                    ...
                    Intent intent = new Intent(DubanTopersonLeaderListActivity.this,
            ...
            public View initView(Context context, int position,
                ...
                if (convertView == null) {
                    convertView = LinearLayout.inflate(
                            DubanTopersonLeaderListActivity.this,
...
//                warp.setText(R.id.tv_status, comp.getStatuss());  //处理状态
        ...
        public View getView() {
            if (view == null) {
                view = LinearLayout.inflate(DubanTopersonLeaderListActivity.this,
                        R.layout.confs_chief_complist, null);
                adapter = new SimpleListAdapter(DubanTopersonLeaderListActivity.this,
                        items, initor);
                listViewWarp = new ListViewWarp(DubanTopersonLeaderListActivity.this,
                        adapter, this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.note_to_leader);
        ...
        pagerItems.add(new DubanTopersonLeaderListActivity.CompListPager(0));
        pagerItems.add(new DubanTopersonLeaderListActivity.CompListPager(1));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ((DubanTopersonLeaderListActivity.CompListPager) pagerItems
