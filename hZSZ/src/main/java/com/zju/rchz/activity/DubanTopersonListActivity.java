...
//                warp.setText(R.id.tv_status, comp.getStatuss());  //处理状态
        ...
        public View getView() {
            if (view == null) {
                view = LinearLayout.inflate(DubanTopersonListActivity.this,
                        R.layout.confs_chief_complist, null);
                adapter = new SimpleListAdapter(DubanTopersonListActivity.this,
                        items, initor);
                listViewWarp = new ListViewWarp(DubanTopersonListActivity.this,
                        adapter, this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pagerItems.add(new DubanTopersonListActivity.CompListPager(0));
        pagerItems.add(new DubanTopersonListActivity.CompListPager(1));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ((DubanTopersonListActivity.CompListPager) pagerItems
