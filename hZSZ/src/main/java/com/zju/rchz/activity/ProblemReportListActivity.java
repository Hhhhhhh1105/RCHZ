...
/**
 * Created by ZJTLM4600l on 2017/8/25.
 */
        ...
        adapter = new SimpleListAdapter(this, comps, new SimpleViewInitor() {
            ...
            public View initView(Context context, int position, View convertView, ViewGroup parent, Object data) {
                if (convertView == null) {
                    ...
                    convertView = LinearLayout.inflate(ProblemReportListActivity.this, R.layout.item_complaint, null);
                }
                CompSugs comp = (CompSugs) data;
                ViewWarp warp = new ViewWarp(convertView, ProblemReportListActivity.this);
...
//                } else
                if (v.getId() == R.id.btn_vieworder) {
                    Intent intent = new Intent(ProblemReportListActivity.this, ProblemReportDetailActivity.class);
                    intent.putExtra(Tags.TAG_COMP, StrUtils.Obj2Str(comp));
...
//        }
    ...
    private void loadComps(final boolean refresh) {
        ...
        getRequestContext().add("pro_report_list_get", new Callback<CompDataRes>() {
            @Override
