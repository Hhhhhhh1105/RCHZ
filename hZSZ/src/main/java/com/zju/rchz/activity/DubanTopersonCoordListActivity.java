...
/**
 * Created by ZJTLM4600l on 2017/9/30.
 *
 * 协管员  获得问题上报后的督办单list
 */

public class DubanTopersonCoordListActivity extends BaseActivity implements ViewPager.OnPageChangeListener, RadioGroup.OnCheckedChangeListener{
    public class CompListPager extends PagerItem implements ListViewWarp.WarpHandler {
        ...
        private View.OnClickListener btnClk = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (v.getTag() instanceof DubanTopersonObject) {
                    ...
                    Intent intent = new Intent(DubanTopersonCoordListActivity.this,
            ...
            public View initView(Context context, int position,
                ...
                if (convertView == null) {
                    convertView = LinearLayout.inflate(
                            DubanTopersonCoordListActivity.this,
                ...
                warp.setText(R.id.tv_time, comp.getTime() != null ? comp
                        .getTime().getYMDHM(DubanTopersonCoordListActivity.this) : "");    //投诉时间
        ...
        public View getView() {
            if (view == null) {
                view = LinearLayout.inflate(DubanTopersonCoordListActivity.this,
                        R.layout.confs_chief_complist, null);
                adapter = new SimpleListAdapter(DubanTopersonCoordListActivity.this,
                        items, initor);
                listViewWarp = new ListViewWarp(DubanTopersonCoordListActivity.this,
                        adapter, this);
        ...
        private void loadComps(final boolean refresh) {
            ...
            getRequestContext().add(
                    "Get_CoordinatorDubanToperson_List",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pagerItems.add(new DubanTopersonCoordListActivity.CompListPager(0));
        pagerItems.add(new DubanTopersonCoordListActivity.CompListPager(1));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ((DubanTopersonCoordListActivity.CompListPager) pagerItems
